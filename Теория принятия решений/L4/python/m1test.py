...
# Отбор особей для скрещивания (для максимизации выбираем лучших - с наибольшими значениями)
def selection(population, fitness_values, num_parents):
    # Сортируем по убыванию fitness (лучшие для максимизации первые)
...
# Основной цикл генетического алгоритма для поиска максимума
def genetic_algorithm(population_size=100, generations=100, chromosome_length=16, mutation_rate=0.01):
    ...
    for generation in range(generations):
        ...
        # Для максимизации ищем наибольшее значение fitness
    ...
    # Находим лучшую особь в финальной популяции (максимум)
...
if __name__ == "__main__":
    ...
    print(f"\n=== РЕЗУЛЬТАТЫ ===")
    print(f"Найденный максимум: x={best_x:.6f}, y={best_y:.6f}")
    print(f"Значение функции в максимуме: {best_fitness:.8f}")
